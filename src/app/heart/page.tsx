      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-[#1a1a2e] border border-[#2a2a3e] rounded-lg p-6 mb-8">
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label htmlFor="cp" className="block text-sm font-medium text-gray-300 mb-1">
            ...
            <div>
              <label htmlFor="trestbps" className="block text-sm font-medium text-gray-300 mb-1">
            ...
            <div>
              <label htmlFor="fbs" className="block text-sm font-medium text-gray-300 mb-1">
            ...
            <div>
              <label htmlFor="restecg" className="block text-sm font-medium text-gray-300 mb-1">
            ...
            <div>
              <label htmlFor="thalach" className="block text-sm font-medium text-gray-300 mb-1">
            ...
            <div>
              <label htmlFor="exang" className="block text-sm font-medium text-gray-300 mb-1">
            ...
            <div>
              <label htmlFor="oldpeak" className="block text-sm font-medium text-gray-300 mb-1">
            ...
            <div>
              <label htmlFor="slope" className="block text-sm font-medium text-gray-300 mb-1">
            ...
            <div>
              <label htmlFor="ca" className="block text-sm font-medium text-gray-300 mb-1">
            ...
            <div>
              <label htmlFor="thal" className="block text-sm font-medium text-gray-300 mb-1">
